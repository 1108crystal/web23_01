    ...
    <form method="post" action="../api/edit.php">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <input type="button" onclick="op('#cover','#cvr','./modal/upload_image.php?id=<?= $row['id']; ?>;table=Mvim')" value="更新圖片">
        ...
        <table style="margin-top:40px; width:70%;">
            <tbody>
                <tr>
                    <td width="200px">
                        <input type="button" onclick="op('#cover','#cvr','./modal/image.php')" value="新增校園印像圖片">
                    </td>
                    <td class="cent">
